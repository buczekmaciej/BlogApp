  ...
  searchContainer.addEventListener("click", e => {
    if (e.target.className === "glyphicon glyphicon-search") {
      searchContainer.innerHTML =
        '<div class="searchGroup"><button type="button" class="search" id="searchButton"><i class="glyphicon glyphicon-search"></i></button><input type="text" class="searchInput" id="searchContent"/></div>';
