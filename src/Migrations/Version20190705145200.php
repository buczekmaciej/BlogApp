 ...
 */
final class Version20190705145200 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE details (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, first_name VARCHAR(255) DEFAULT NULL, birthday_date DATETIME DEFAULT NULL, location VARCHAR(255) DEFAULT NULL, bio CLOB DEFAULT NULL)');
        ...
        $this->addSql('ALTER TABLE user ADD COLUMN joined_at DATETIME DEFAULT NULL');
    }
